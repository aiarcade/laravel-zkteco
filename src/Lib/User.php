...
class User
{
     ...
     * @return bool|mixed
     */
    public static function set(LaravelZkteco $self, $uid, $userid, $name, $password, $role = Util::LEVEL_USER, $cardno = 0)
    {
        ...
        $byte2 = chr((int) ($uid >> 8));
        $cardno = pack('V', (int)$cardno);
        //hex2bin(Util::reverseHex(dechex($cardno)));
